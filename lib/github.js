...
function parseBlogPost(repo, rawMarkdown, blogJson = null) {
  ...
  // Title: frontmatter or formatted repository name or raw repo name
  const title = frontmatter.title || formatSlugToTitle(repo.name) || repo.name;

  // Description: repo description without [blog] tag or frontmatter description
